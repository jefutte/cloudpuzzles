    ...
    Node $AllNodes.NodeName
    {
        ...
        )
        {
            WindowsFeature "NET-Framework-Core"
            {
                ...
                Source = $Node.SourcePath + "\WindowsServer\sources\sxs"
            }
        }
...
$InstallerServiceAccount = New-Object System.Management.Automation.PSCredential ("domain\dpmsvc", $SecurePassword)
        ...
        @{
            ...
            SQLServers = @(
                @{
                    ...
                    InstallSQLDataDir = "E:\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\Data"
                    SQLUserDBDir = "E:\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\Data"
                    SQLUserDBLogDir = "E:\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\Data"
                    SQLTempDBDir = "E:\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\Data"
                    SQLTempDBLogDir = "E:\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\Data"
                    SQLBackupDir = "E:\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\Data"
                }
            )
        }
    )
